function data = create_cost_table
    ...
    for i = 1:missions.size
        ...
        data(n,1:4) = {'payload-cost#' mission.getSlotValue('payload-cost#').floatValue(c) mission.getSlotValue('payload-non-recurring-cost#').floatValue(c) mission.getSlotValue('payload-recurring-cost#').floatValue(c)};n=n+1;
